...
final class ControllerTest extends TestCase
{
    public function testGetModuleNameFromModulesNamespace(): void
    {
        ...
        if (!class_exists(Modules\Foo\Controllers\DemoController::class)) {
            eval('namespace Modules\\Foo\\Controllers; class DemoController extends \\Ishmael\\Core\\Controller { public function expose(): string { return $this->getModuleName(); } }');
        }
    ...
    public function testGetModuleNameDefaultsToApp(): void
    {
        if (!class_exists(Tests\DummyBaseController::class)) {
            eval('namespace Tests; class DummyBaseController extends \\Ishmael\\Core\\Controller { public function expose(): string { return $this->getModuleName(); } }');
        }
