...
<head>
  <meta charset="utf-8">
  <title><?php echo htmlspecialchars($title ?? 'Users', ENT_QUOTES, 'UTF-8'); ?></title>
  ...
  <style>
    ...
    input, textarea, select { width:100%; padding:.5rem; border:1px solid #ccc; border-radius:.25rem }
...
<body>
  <div class="container">
    <?php if (function_exists('flash') && ($m = flash('error'))) : ?>
      <div class="flash" style="background:#fee2e2;border-color:#fecaca;color:#7f1d1d;"><?php echo htmlspecialchars((string)$m, ENT_QUOTES, 'UTF-8'); ?></div>
    <?php endif; ?>
    <?php if (function_exists('flash') && ($m = flash('success'))) : ?>
